...
const Section3Guide = () => {
  ...
  return (
    <div className='grid w-full grid-cols-[1fr] justify-items-center gap-10 self-center px-4 py-8 lg:w-[90%] lg:grid-cols-[1fr_1fr] lg:justify-items-start'>
      <div>
        <h1 className='mb-4 text-center text-5xl font-bold text-[#443928] lg:text-left'>
          Tail-Wagging Goodness in Every Bowl
        </h1>

        <p className='mb-6 text-center leading-[1.8] text-[#443928] lg:text-left'>
      ...
      <div className='grid grid-cols-[auto_auto] items-center justify-self-center lg:gap-x-10'>
        <div className='relative flex h-[400px] w-[240px] flex-col items-center justify-center overflow-hidden rounded-xl border-[2px] border-[#7B6D57] lg:rotate-[-5deg]'>
          ...
          <button
            ...
            onClick={() =>
              window.open('https://www.instagram.com/p/DFFNUvLzq2K/', '_blank')
            }
          >
            <FaYoutube className='h-12 w-12' />
            <div className='text-left'>
              <p>How It's Made</p>
              <p className='truncate text-xs'>Our process, ratios & formula</p>
            </div>
          </button>
        </div>
