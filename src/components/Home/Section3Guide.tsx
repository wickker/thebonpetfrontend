      ...
      <div className='mx-auto grid w-full max-w-[1650px] grid-cols-[1fr] items-center gap-10 px-4 py-8 lg:w-[90%] lg:grid-cols-[1fr_1fr]'>
        <div>
          ...
          <div className='flex flex-wrap items-center justify-center gap-4 lg:justify-start'>
            ...
            <button
              className='border-green text-green flex min-w-fit cursor-pointer items-center gap-2 rounded-xl border-[3px] px-4 py-2 text-2xl whitespace-nowrap transition-all hover:scale-x-102 hover:shadow-[0_0_10px_rgba(0,0,0,0.3)] disabled:hover:cursor-not-allowed'
