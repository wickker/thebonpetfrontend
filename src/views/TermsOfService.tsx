      ...
      <div className='flex w-[100dvw] flex-col px-4 sm:w-full md:w-3/4 lg:w-2/3'>
        ...
        <div className='text-dark-green space-y-6 pb-12'>
          <section className='space-y-4'>
            ...
            <p>
              This website is operated by The Bon Pet. Throughout the site, the
              terms "we", "us" and "our" refer to The Bon Pet. The Bon Pet
          ...
          <section className='space-y-4'>
            <h2 className='text-xl font-bold'>SECTION 7 - OPTIONAL TOOLS</h2>
            <p>
          ...
          <section className='space-y-4'>
            <h2 className='text-xl font-bold'>SECTION 8 - THIRD-PARTY LINKS</h2>
            <p>
          ...
          <section className='space-y-4'>
            <h2 className='text-xl font-bold'>SECTION 12 - PROHIBITED USES</h2>
            <p>
          ...
          <section className='space-y-4'>
            ...
            <p>
              In no case shall The Bon Pet, our directors, officers, employees,
          ...
          <section className='space-y-4'>
            <h2 className='text-xl font-bold'>SECTION 14 - INDEMNIFICATION</h2>
            <p>
              You agree to indemnify, defend and hold harmless The Bon Pet and
          ...
          <section className='space-y-4'>
            <h2 className='text-xl font-bold'>SECTION 15 - SEVERABILITY</h2>
            <p>
          ...
          <section className='space-y-4'>
            <h2 className='text-xl font-bold'>SECTION 16 - TERMINATION</h2>
            <p>
          ...
          <section className='space-y-4'>
            <h2 className='text-xl font-bold'>SECTION 17 - ENTIRE AGREEMENT</h2>
            <p>
          ...
          <section className='space-y-4'>
            <h2 className='text-xl font-bold'>SECTION 18 - GOVERNING LAW</h2>
            <p>
